...
class Consultation(models.Model):
    ...
    """
    # Relation "Aboutir" 1..1 avec le RDV (Un RDV donne une Consultation)
    # On utilise une chaîne de caractères 'planning.RDV' pour éviter les imports circulaires
    ...
    # Relation "Composer" 1..n avec Acte (ManyToMany)
    ...
    # Relation récursive "Est révision" / "Id_Cons_origine"
    ...
    # Champ booléen explicite comme dans le diagramme (bien que déductible via consultation_origine)
    est_revision = models.BooleanField(default=False, verbose_name="Est une révision")

    def save(self, *args, **kwargs):
        # Automatisation : si une consultation origine est définie, c'est une révision
